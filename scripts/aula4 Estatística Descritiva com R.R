...
# Tabela de Frequencia absoluta da variável Species da base iris
table(iris$Species)

# Tabela de Frequencia relativa da variável Species da base iris
prop.table(table(iris$Species))

# Media da variável Sepal.Length da base iris
...
boxplot(iris$Sepal.Length) #boxplot - gráfico que resume as separatrizes
